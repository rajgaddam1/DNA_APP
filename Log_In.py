...
user_other = os.environ.get('user_other')
password_other = os.environ.get('password_other')
...
def intro():
    ...
    if st.button("Sign In"):
        ...
        elif user_other == user_name1 and password_other == password1 and account == account_name:
            st.write('Logged in Successfully')
            switch_page("Streamlit")
